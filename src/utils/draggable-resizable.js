import { matchesSelectorToParentElements, getComputedSize, addEvent, removeEvent } from './draggable-resizable/dom.js'
import { computeWidth, computeHeight, restrictToBounds, snapToGrid } from './draggable-resizable/fns.js'
const template = `
  <div
    :style="style"
    :class="[{
